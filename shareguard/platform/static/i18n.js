...
(function installShareGuardI18n() {
  ...
  const messages = {
    "zh-CN": {
      ...
      "engine.liveSpai": "在线筛查：ShareGuard 受保护筛查引擎 / ShareGuard 决策层",
      "engine.connected": "云端推理网关已连接，等待实际引擎返回",
      "engine.awaiting": "等待云端推理授权；凭证仅保存在当前页面内存",
      ...
      "evidence.compareAria": "对比案件中的原始导入与当前真实上传版本",
      ...
      "evidence.robustnessReview": "案件真实上传版本对比",
      "evidence.noLocalization": "图像级判定 / 模型未提供局部定位",
      "evidence.awaitingLocalization": "等待模型结果 / 尚无定位数据",
      "evidence.noViews": "导入影像后显示案件真实上传版本。",
      "provenance.unavailable": "尚未记录来源或传播链路。",
      "decision.score": "模型判定",
      "decision.margin": "判定强度",
      "decision.boundary": "边界状态",
      "decision.marginHelp": "判定强度",
      "decision.action": "系统动作",
      "decision.testimony": "模型证据",
      "decision.provenance": "溯源拓扑",
      "decision.force": "强制放行",
      "decision.seal": "签封并导出",
      "decision.hold.en": "SUSPEND",
      "decision.hold.local": "暂停分发",
      "decision.review.en": "REVIEW",
      "decision.review.local": "进入复核",
      ...
      "report.scoreLabel": "模型判定",
      "report.marginLabel": "判定强度",
      "report.scoreNoticeLabel": "模型记录",
      "report.actionLabel": "系统动作",
      "report.testimonyLabel": "模型证据",
      "report.statementLabel": "声明",
      "decision.disclaimer": "模型判定、系统动作与处置确认将写入保全日志。",
      "model.verdict.generated": "AI生成",
      "model.verdict.camera": "真人拍摄",
      "model.verdict.review": "需专项复核",
      "strength.high": "高",
      "strength.medium": "中",
      "strength.boundary": "边界",
      "strength.unknown": "未提供",
      "action.hold": "暂停分发并进入签封",
      "action.allow": "允许使用并保存报告",
      "action.review": "进入专项复核队列",
      "summary.hold": "ShareGuard判定该影像为AI生成内容，系统已暂停分发并建立签封任务。",
      "summary.allow": "ShareGuard判定该影像为真人拍摄内容，系统已允许使用并保存检测报告。",
      "summary.review": "ShareGuard已将该影像置入专项复核队列，并锁定当前版本与证据记录。",
      ...
      "seal.failed": "签封失败",
      "seal.notice": "证据包已由 ShareGuard 受保护签发服务签名，并绑定固定信任根。",
      "seal.download": "下载 .sgd 证据包",
      "seal.verifier": "打开独立验证器",
      "release.title": "确认强制放行？",
      "release.body": "系统将保留模型结论，并把本次处置变更写入保全日志。",
      "release.cancel": "取消",
      ...
      "verifier.disclaimer": "验证器只信任预置的 ShareGuard 签发公钥，不接受证据包自行携带的公钥。",
      ...
      "case.upload.briefing": "导入影像后，系统调用云端筛查引擎生成图像级判定、系统动作与证据记录。"
    },
    "en": {
      ...
      "nav.locale": "切换至中文",
      "engine.liveSpai": "Live screening: ShareGuard Protected Screening Engine / ShareGuard decision layer",
      "engine.connected": "Cloud inference connected; awaiting the live engine response",
      "engine.awaiting": "Cloud-inference authorization required. Credentials remain in page memory.",
      ...
      "model.endpoint": "Protected gateway",
      ...
      "evidence.compareAria": "Compare the original intake with the selected uploaded case version",
      ...
      "evidence.robustnessReview": "Comparison of uploaded case versions",
      ...
      "evidence.noViews": "Import media to create a case version.",
      "provenance.unavailable": "No source or propagation path has been recorded.",
      "decision.score": "Model verdict",
      "decision.margin": "Decision strength",
      "decision.boundary": "Boundary state",
      "decision.marginHelp": "Decision strength",
      "decision.action": "System action",
      "decision.testimony": "Model evidence",
      "decision.provenance": "Provenance topology",
      "decision.force": "Force Release",
      "decision.seal": "Seal & Export",
      "decision.hold.en": "SUSPEND",
      "decision.hold.local": "DISTRIBUTION PAUSED",
      "decision.review.en": "REVIEW",
      "decision.review.local": "SPECIALIST REVIEW",
      "decision.allow.en": "RELEASE",
      ...
      "report.scoreLabel": "Model verdict",
      "report.marginLabel": "Decision strength",
      "report.scoreNoticeLabel": "Model record",
      "report.actionLabel": "System action",
      "report.testimonyLabel": "Model evidence",
      "report.statementLabel": "Statement",
      "decision.disclaimer": "Model verdicts, system actions, and operator confirmations are written to the custody log.",
      "model.verdict.generated": "AI-GENERATED",
      "model.verdict.camera": "CAMERA-CAPTURED",
      "model.verdict.review": "SPECIALIST REVIEW",
      "strength.high": "HIGH",
      "strength.medium": "MEDIUM",
      "strength.boundary": "BOUNDARY",
      "strength.unknown": "UNAVAILABLE",
      "action.hold": "PAUSE DISTRIBUTION AND SEAL",
      "action.allow": "ALLOW USE AND SAVE REPORT",
      "action.review": "ROUTE TO SPECIALIST REVIEW",
      "summary.hold": "ShareGuard classifies this image as AI-generated. Distribution is paused and a sealing task is active.",
      "summary.allow": "ShareGuard classifies this image as camera-captured. Use is allowed and the detection report is retained.",
      "summary.review": "ShareGuard has routed this image to specialist review and locked the current version and evidence record.",
      ...
      "review.open": "Review Collaboration",
      ...
      "seal.notice": "The package was signed by the protected ShareGuard issuing service and bound to a pinned trust root.",
      "seal.download": "Download .sgd Package",
      "seal.verifier": "Open Independent Verifier",
      "release.title": "Confirm forced release?",
      "release.body": "The model finding is retained and this disposition change is appended to the custody log.",
      ...
      "verifier.disclaimer": "The verifier trusts only pinned ShareGuard issuer keys and ignores keys supplied by a package.",
      ...
      "case.upload.briefing": "After import, the cloud screening engine generates an image-level verdict, system action, and evidence record."
    }
  };
