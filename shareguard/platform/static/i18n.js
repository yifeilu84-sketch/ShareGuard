...
(function installShareGuardI18n() {
  ...
  const messages = {
    "zh-CN": {
      ...
      "model.description": "输入演示凭证后，影像会通过加密连接发送到私有推理网关。模型权重与内部参数不会进入浏览器或公开仓库。",
      "model.endpoint": "私有网关",
      "model.username": "演示账号",
      "model.password": "访问密码",
      ...
      "model.credentialsRequired": "请输入演示账号和访问密码。",
    ...
    "en": {
      ...
      "model.description": "After authorization, media is sent over an encrypted connection to the private inference gateway. Model weights and internal parameters never enter the browser or public repository.",
      "model.endpoint": "Private gateway",
      "model.username": "Demo username",
      ...
      "model.credentialsRequired": "Enter the demo username and access password.",
      ...
      "model.networkError": "The private model gateway could not be reached. Confirm that the demo service is running.",
      ...
      "model.authorizationRequired": "Enter the demo credentials to run this image through the real model.",
