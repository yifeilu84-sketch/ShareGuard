...
(function installShareGuardI18n() {
  ...
  const messages = {
    "zh-CN": {
      ...
      "engine.awaiting": "等待私有模型授权，凭证不会写入仓库",
      "engine.unavailable": "私有模型连接失败，未生成鉴真结论",
      "model.connect": "连接模型",
      "model.title": "连接 ShareGuard 私有模型",
      "model.description": "输入访问凭证后，影像会通过加密连接发送到私有推理网关。模型权重与内部参数不会进入浏览器或公开仓库。",
      "model.endpoint": "私有网关",
      "model.username": "访问账号",
      "model.password": "访问密码",
      ...
      "model.connecting": "正在验证私有模型网关…",
      "model.invalid": "账号或密码无效，请重新输入。",
      "model.unavailable": "私有模型网关暂不可用。",
      "model.notReady": "私有模型仍在启动，请稍后重试。",
      "model.connected": "连接成功，真实模型推理已启用。",
      "model.networkError": "无法连接私有模型网关，请确认私有服务正在运行。",
      "model.connectedShort": "模型已连接",
      "model.connectingShort": "正在连接",
      "model.retry": "重试连接",
      "model.disconnected": "私有模型连接已断开。",
      "model.waiting": "等待连接私有模型后开始真实分析。",
      ...
      "model.connectAction": "连接私有模型后重新分析",
      ...
      "case.upload.briefing": "导入影像后，系统将调用私有模型生成本次文件的图像级判定；不会以演示数据补全结果。"
    },
    "en": {
      ...
      "engine.awaiting": "Private-model authorization required. Credentials are never committed.",
      "engine.unavailable": "Private-model connection failed. No finding was generated.",
      "model.connect": "Connect Model",
      "model.title": "Connect the ShareGuard Private Model",
      "model.description": "With access credentials, media is sent over an encrypted connection to the private inference gateway. Model weights and internal parameters never enter the browser or public repository.",
      ...
      "model.connecting": "Verifying the private model gateway…",
      "model.invalid": "The username or password is invalid. Please try again.",
      "model.unavailable": "The private model gateway is unavailable.",
      "model.notReady": "The private model is still starting. Please try again shortly.",
      "model.connected": "Connected. Real model inference is enabled.",
      "model.networkError": "The private model gateway could not be reached. Confirm that the private service is running.",
      "model.connectedShort": "Model Online",
      "model.connectingShort": "Connecting",
      "model.retry": "Retry",
      "model.disconnected": "The private model connection has been closed.",
      "model.waiting": "Connect the private model to begin real analysis.",
      ...
      "model.connectAction": "Connect the private model and analyze again",
      "model.importAction": "Import an image to start live analysis",
      "model.awaitingUpload": "Import an image to start live private-model analysis.",
      ...
      "evidence.building": "Calling private model",
      ...
      "workflow.live": "Live private-model verification",
      "case.upload.title": "Imported Media Verification",
      "case.upload.briefing": "After import, the private model returns an image-level result for this file. Demo data is never used to fill missing output."
    }
  };
